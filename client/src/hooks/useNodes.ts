  ...
  const {
    ...
    queryFn: async () => {
      ...
      return filteredNodes.map((d: any) => ({
        ...
        status: computeDeviceStatus(d.last_online_at || d.last_telemetry_seen || d.last_seen || null, d.id),
        latitude: d.latitude,
        longitude: d.longitude,
        is_active: d.is_active ?? (computeDeviceStatus(d.last_online_at || d.last_telemetry_seen || d.last_seen || null) === "Online"),

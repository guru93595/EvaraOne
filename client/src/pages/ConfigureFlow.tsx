...
const ConfigureFlow = () => {
    ...
    useEffect(() => {
        if (device) {
            ...
            setWaterSecurity(features.showWaterSecurity ?? true);
            setSystemDynamics(features.showSystemDynamics ?? true);
            setAlerts(features.showAlerts ?? false);
            setConsumptionPattern(features.showConsumptionPattern ?? true);
    ...
    const saveMutation = useMutation({
        mutationFn: async () => {
            const payload = {
                ...
                features: {
                    showMap: mapView,
                    showWaterSecurity: waterSecurity,
                    showSystemDynamics: systemDynamics,
                    showAlerts: alerts,
                    showConsumptionPattern: consumptionPattern
                }
            };
                        ...
                        <div className="flex flex-col gap-7">
                            ...
                            <div className="flex justify-between items-center mt-2">
                                <button 
                                    ...
                                    onClick={() => {
                                        setMapView(false);
                                        setWaterSecurity(true);
                                        setSystemDynamics(true);
                                        setAlerts(false);
                                        setConsumptionPattern(true);
                                    }}
                                >
                                    Restore Defaults
                                </button>
